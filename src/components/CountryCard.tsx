...
function CountryCard({ data }: { data: CountriesResponse[0] }) {
  return (
    <button className="mb-10 flex w-full cursor-pointer flex-col items-center justify-center rounded-sm bg-white shadow-[0_5px_15px_rgba(0,0,0,0.05)]">
      <div className="h-42 w-full rounded-t-sm bg-blue-200">
        <img
          src={data.flags.png}
